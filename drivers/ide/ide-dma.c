...
static unsigned int ide_get_mode_mask(ide_drive_t *drive, u8 base, u8 req_mode)
{
	...
	case XFER_UDMA_0:
		 ...
		 */
		/* For certain cards such as the Extreme IV Sandisk, the
		 * 80c ribbon Cable is not detected and the speed is limited
		 * to UDMA2/33MBps. Comment the below lines to avoid
		 * the 80c cable check.
		 */
		/*
