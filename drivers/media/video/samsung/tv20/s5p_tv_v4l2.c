	...
	struct v4l2_capability *cap)
{
	...
	cap->version = KERNEL_VERSION(2, 6, 31);

	return 0;
}

/* Priority handling */
static int s5p_tv_v4l2_g_priority(struct file *file, void *fh,
	enum v4l2_priority *p)
{
	return 0;
}

static int s5p_tv_v4l2_s_priority(struct file *file, void *fh,
	enum v4l2_priority p)
{
	return 0;
}
	...
	struct v4l2_format *f)
{
	...
	case V4L2_BUF_TYPE_VIDEO_OUTPUT: {
		...
		vparam.pix_fmt.pixelformat = s5ptv_status.src_color;
...
static int s5p_tv_v4l2_g_fmt_vid_out_overlay(struct file *file, void *fh,
	struct v4l2_format *f)
{
	...
	case V4L2_BUF_TYPE_VIDEO_OUTPUT_OVERLAY: {
		...
		V4L2PRINTK("[type 0x%08x] : left: [%d], top [%d], width[%d],\
			height[%d]\n",
			   f->type,
...
static int s5p_tv_v4l2_try_fmt_vid_out_overlay(struct file *file, void *fh,
	struct v4l2_format *f)
{
	return 0;
}
...
/* Buffer handlers */
static int s5p_tv_v4l2_reqbufs(struct file *file, void *fh,
	struct v4l2_requestbuffers *b)
{
	return 0;
}

static int s5p_tv_v4l2_querybuf(struct file *file, void *fh,
	struct v4l2_buffer *b)
{
	return 0;
}

static int s5p_tv_v4l2_qbuf(struct file *file, void *fh,
	struct v4l2_buffer *b)
{
	return 0;
}

static int s5p_tv_v4l2_dqbuf(struct file *file, void *fh,
	struct v4l2_buffer *b)
{
	return 0;
}
...
/* start overlay * */
static int s5p_tv_v4l2_overlay(struct file *file, void *fh,
	unsigned int i)
{
	s5p_tv_vo *layer = (s5p_tv_vo *)fh;
	int	start = i;
...
static int s5p_tv_v4l2_g_std(struct file *file, void *fh,
	v4l2_std_id *norm)
{
	V4L2PRINTK("()++\n");
...
static int s5p_tv_v4l2_s_std(struct file *file, void *fh,
	v4l2_std_id *norm)
{
	unsigned int i = 0;
	...
	if (i >= S5P_TVOUT_MAX_STANDARDS || s5ptv_status.v4l2.std == NULL) {
		V4L2PRINTK("(ERR) There is no tv-out standards : index =\
			0x%08Lx\n", std_id);
		return -EINVAL;
	}
...
#endif
	default:
		V4L2PRINTK("(ERR) not supported standard id : index =\
			0x%08Lx\n", std_id);
		return -EINVAL;
		break;
	}
...
/* Control handling */
static int s5p_tv_v4l2_queryctrl(struct file *file, void *fh,
	struct v4l2_queryctrl *a)
{
	return 0;
}

static int s5p_tv_v4l2_g_ctrl(struct file *file, void *fh,
	struct v4l2_control *a)
{
	return 0;
}

static int s5p_tv_v4l2_s_ctrl(struct file *file, void *fh,
	struct v4l2_control *a)
{
	return 0;
}

static int s5p_tv_v4l2_g_ext_ctrls(struct file *file, void *fh,
	struct v4l2_ext_controls *a)
{
	return 0;
}

static int s5p_tv_v4l2_s_ext_ctrls(struct file *file, void *fh,
	struct v4l2_ext_controls *a)
{
	return 0;
}

static int s5p_tv_v4l2_try_ext_ctrls(struct file *file, void *fh,
	struct v4l2_ext_controls *a)
{
	return 0;
}

static int s5p_tv_v4l2_querymenu(struct file *file, void *fh,
...
/* Audio ioctls */
static int s5p_tv_v4l2_enumaudio(struct file *file, void *fh,
	struct v4l2_audio *a)
{
	return 0;
}

static int s5p_tv_v4l2_g_audio(struct file *file, void *fh,
	struct v4l2_audio *a)
{
	return 0;
}

static int s5p_tv_v4l2_s_audio(struct file *file, void *fh,
	struct v4l2_audio *a)
{
	return 0;
}
...
/* Audio out ioctls */
static int s5p_tv_v4l2_enumaudout(struct file *file, void *fh,
	struct v4l2_audioout *a)
{
	return 0;
}

static int s5p_tv_v4l2_g_audout(struct file *file, void *fh,
	struct v4l2_audioout *a)
{
	return 0;
}

static int s5p_tv_v4l2_s_audout(struct file *file, void *fh,
	struct v4l2_audioout *a)
{
	return 0;
}

static int s5p_tv_v4l2_g_modulator(struct file *file, void *fh,
	struct v4l2_modulator *a)
{
	return 0;
}

static int s5p_tv_v4l2_s_modulator(struct file *file, void *fh,
	struct v4l2_modulator *a)
{
	return 0;
}
...
static int s5p_tv_v4l2_g_crop(struct file *file, void *fh,
	struct v4l2_crop *a)
{
	...
	struct v4l2_streamparm *a)
{
	...
	s5ptv_overlay[layer->index].blank_color = vparam.win.chromakey;
	...
	s5ptv_overlay[layer->index].win.global_alpha = vparam.win.global_alpha;
...
static int s5p_tv_v4l2_s_hw_freq_seek(struct file *file, void *fh,
