...
extern 	bool _s5p_grp_init_param(s5p_tv_vmx_layer vm_layer,
...
s5p_tv_hdmi_err __s5p_hdmi_video_init_avi_infoframe(
	s5p_hdmi_transmit trans_type, u8 check_sum, u8 *pavi_data);
s5p_tv_hdmi_err __s5p_hdmi_video_init_mpg_infoframe(
	s5p_hdmi_transmit trans_type, u8 check_sum, u8 *pmpg_data);
void __s5p_hdmi_video_init_tg_cmd(bool t_correction_en, bool BT656_sync_en,
	bool tg_en);
bool __s5p_hdmi_start(s5p_hdmi_audio_type hdmi_audio_type, bool HDCP_en,
	struct i2c_client *ddc_port);
void __s5p_hdmi_stop(void);

/* SDOUT */
s5p_tv_sd_err __s5p_sdout_init_video_scale_cfg(s5p_sd_level component_level,
	s5p_sd_vsync_ratio component_ratio, s5p_sd_level composite_level,
	s5p_sd_vsync_ratio composite_ratio);
s5p_tv_sd_err __s5p_sdout_init_sync_signal_pin(s5p_sd_sync_sig_pin pin);
s5p_tv_sd_err __s5p_sdout_init_vbi(bool wss_cvbs,
	s5p_sd_closed_caption_type caption_cvbs, bool wss_y_sideo,
	s5p_sd_closed_caption_type caption_y_sideo, bool cgmsa_rgb,
	bool wss_rgb, s5p_sd_closed_caption_type caption_rgb,
...
s5p_tv_sd_err __s5p_sdout_init_dac_power_onoff(s5p_sd_channel_sel channel,
	bool dac_on);
...
s5p_tv_sd_err __s5p_sdout_init_vesa_rgb_sync(
	s5p_sd_vesa_rgb_sync_type sync_type,
...
s5p_tv_sd_err __s5p_sdout_init_ch_xtalk_cancel_coef(
	s5p_sd_channel_sel channel, u32 coeff2, u32 coeff1);
...
s5p_tv_sd_err __s5p_sdout_init_wss525_data(s5p_sd_525_copy_permit copy_permit,
	s5p_sd_525_mv_psp mv_psp, s5p_sd_525_copy_info copy_info,
	bool analog_on, s5p_sd_525_aspect_ratio display_ratio);
s5p_tv_sd_err __s5p_sdout_init_wss625_data(bool surround_sound,
	bool copyright, bool copy_protection, bool text_subtitles,
	s5p_sd_625_subtitles open_subtitles,
	s5p_sd_625_camera_film camera_film,
	s5p_sd_625_color_encoding color_encoding,
	bool helper_signal, s5p_sd_625_aspect_ratio display_ratio);
s5p_tv_sd_err __s5p_sdout_init_cgmsa525_data(
	s5p_sd_525_copy_permit copy_permit, s5p_sd_525_mv_psp mv_psp,
	s5p_sd_525_copy_info copy_info, bool analog_on,
	s5p_sd_525_aspect_ratio display_ratio);
s5p_tv_sd_err __s5p_sdout_init_cgmsa625_data(bool surround_sound,
	bool copyright, bool copy_protection, bool text_subtitles,
	s5p_sd_625_subtitles open_subtitles,
	s5p_sd_625_camera_film camera_film,
	s5p_sd_625_color_encoding color_encoding, bool helper_signal,
	s5p_sd_625_aspect_ratio display_ratio);
s5p_tv_sd_err __s5p_sdout_init_display_mode(s5p_tv_disp_mode disp_mode,
	s5p_tv_o_mode out_mode, s5p_sd_order order);
...
s5p_tv_vmx_err __s5p_vm_set_layer_priority(s5p_tv_vmx_layer layer,
	u32 priority);
s5p_tv_vmx_err __s5p_vm_set_grp_base_address(s5p_tv_vmx_layer layer,
	u32 baseaddr);
s5p_tv_vmx_err __s5p_vm_set_grp_layer_position(s5p_tv_vmx_layer layer,
...
s5p_tv_vmx_err __s5p_vm_init_status_reg(s5p_vmx_burst_mode burst,
	s5p_endian_type endian);
s5p_tv_vmx_err __s5p_vm_init_display_mode(s5p_tv_disp_mode mode,
	s5p_tv_o_mode output_mode);

#ifdef CONFIG_CPU_S5PC100
s5p_tv_vmx_err __s5p_vm_init_layer(s5p_tv_vmx_layer layer, bool show,
	bool winblending, u32 alpha, u32 priority, s5p_tv_vmx_color_fmt color,
	bool blankchange, bool pixelblending, bool premul, u32 blankcolor,
	u32 baseaddr, u32 span, u32 width, u32 height, u32 src_offs_x,
	u32 src_offs_y, u32 dst_offs_x, u32 dst_offs_y);
#endif

/* for grp layer scaling */
#ifdef CONFIG_CPU_S5PV210
s5p_tv_vmx_err __s5p_vm_init_layer(s5p_tv_disp_mode mode,
	s5p_tv_vmx_layer layer, bool show, bool winblending,
	u32 alpha, u32 priority, s5p_tv_vmx_color_fmt color,
	bool blankchange, bool pixelblending, bool premul, u32 blankcolor,
	u32 baseaddr, u32 span, u32 width, u32 height, u32 src_offs_x,
	u32 src_offs_y, u32 dst_offs_x, u32 dst_offs_y, u32 dst_x, u32 dst_y);
#endif
...
s5p_tv_vmx_err __s5p_vm_init_csc_coef(s5p_yuv_fmt_component component,
	s5p_tv_coef_y_mode mode, u32 coeff0, u32 coeff1, u32 coeff2);
...
s5p_tv_vmx_err __s5p_vm_set_underflow_interrupt_enable(s5p_tv_vmx_layer layer,
	bool en);
...
s5p_tv_vp_err __s5p_vp_set_bottom_field_address(u32 bottom_y_addr,
	u32 bottom_c_addr);
...
void __s5p_vp_init_op_mode(bool line_skip, s5p_vp_mem_mode mem_mode,
	s5p_vp_chroma_expansion chroma_exp, s5p_vp_filed_id_toggle toggle_id);
void __s5p_vp_init_pixel_rate_control(s5p_vp_pxl_rate rate);
s5p_tv_vp_err __s5p_vp_init_layer(u32 top_y_addr, u32 top_c_addr,
	u32 bottom_y_addr, u32 bottom_c_addr, s5p_endian_type src_img_endian,
...
s5p_tv_vp_err __s5p_vp_init_layer_def_poly_filter_coef(u32 top_y_addr,
	...
	s5p_endian_type src_img_endian, u32 img_width, u32 img_height,
...
extern int s5p_hdmi_register_isr(irqreturn_t (*isr)(int), u8 irq_num);
