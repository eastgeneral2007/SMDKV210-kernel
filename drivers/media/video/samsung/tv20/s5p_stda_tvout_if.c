 ...
 *
 * S5PV210 - TVOut interface ftn. file for Samsung TVOut driver
 *
...
bool _s5p_tv_if_init_vm_reg(void)
{
	...
	s5p_tv_vmx_csc_type csc_type = VMIXER_CSC_RGB_TO_YUV601_FR;
	...
	case TVOUT_OUTPUT_COMPONENT_RGB_PROGRESSIVE:
		csc_type = VMIXER_CSC_RGB_TO_YUV601_FR;
		break;
	...
	case TVOUT_OUTPUT_DVI:
		...
		case TVOUT_1080P_50:
#endif
			csc_type = VMIXER_CSC_RGB_TO_YUV709_FR;
			break;
		}
	...
	__s5p_vm_init_csc_coef_default(csc_type);
...
bool _s5p_tv_if_init_sd_reg(void)
{
	...
	s5p_sd_closed_caption_type cap_y_svideo =
	...
	s5p_sd_525_aspect_ratio w5_display_ratio =
		st->sdout_wss_525.display_ratio;
	s5p_sd_625_subtitles w6_open_subtitles =
		st->sdout_wss_625.open_subtitles;
	s5p_sd_625_camera_film w6_camera_film = st->sdout_wss_625.camera_film;
	s5p_sd_625_color_encoding w6_color_encoding =
		st->sdout_wss_625.color_encoding;
	s5p_sd_625_aspect_ratio w6_display_ratio =
	...
	sderr = __s5p_sdout_init_vbi(wss_cvbs, cap_cvbs, wss_y_svideo,
		cap_y_svideo, cgmsa_rgb, wss_rgb, cap_rgb, cgmsa_y, wss_y,
		cap_y_pb_pr);
...
bool _s5p_tv_if_set_disp(void)
{
	...
	case TVOUT_OUTPUT_HDMI:
	case TVOUT_OUTPUT_DVI:
		st->hdmi_video_blue_screen.cb_b = 0;
		st->hdmi_video_blue_screen.y_g  = 0;
		st->hdmi_video_blue_screen.cr_r = 0;
		break;
