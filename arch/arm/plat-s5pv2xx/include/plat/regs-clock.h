/* linux/arch/arm/plat-s5pc1xx/include/plat/regs-clock.h
 *
 * Copyright (c) 2010 Samsung Electronics Co., Ltd.
 *		http://www.samsung.com/
 *
 * S5PV2XX Clock register
 *
...
#define S5P_IECREG(x)		(S5PV2XX_VA_IEC + (x))
#define S5P_APCREG(x)		(S5PV2XX_VA_APC + (x))
...
#define S5P_CLKGATE_IP3_ALWAYS_ON	( S5P_CLKGATE_IP3_SYSCON | S5P_CLKGATE_IP3_GPIO |\
					...
					S5P_CLKGATE_IP3_RTC | S5P_CLKGATE_IP3_SYSTIMER |\
					S5P_CLKGATE_IP3_TSADC | S5P_CLKGATE_IP3_WDT |\
					S5P_CLKGATE_IP3_PWM | S5P_CLKGATE_IP3_I2C0 |\
