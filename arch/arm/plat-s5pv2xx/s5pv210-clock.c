/* linux/arch/arm/plat-s5pv2xx/s5pc100-clock.c
 *
...
*/
static unsigned long s5pv2xx_roundrate_clksrc(struct clk *clk, unsigned long rate);

/** xtal_rate:
 * This value stores external xtal frequency
 */ 
...
static unsigned long s5pv2xx_clk_moutapll_get_rate(struct clk *clk)
{
	unsigned long rate;

	rate = s5pv2xx_get_pll(xtal_rate, __raw_readl(S5P_APLL_CON),
						S5PV2XX_PLL_APLL);
...
struct clksrc_clk clk_mout_apll = {
	.clk	= {
		.name		= "mout_apll",
		.id		= -1,
		.get_rate	= s5pv2xx_clk_moutapll_get_rate,
	},
...
static unsigned long s5pv2xx_clk_doutapll_get_rate(struct clk *clk)
{
...
int s5pv2xx_clk_doutapll_set_rate(struct clk *clk, unsigned long rate)
{
...
static unsigned long s5pv2xx_doutapll_roundrate(struct clk *clk,
					      unsigned long rate)
{
...
struct clk clk_dout_apll = {
	...
	.get_rate = s5pv2xx_clk_doutapll_get_rate,
	.set_rate = s5pv2xx_clk_doutapll_set_rate,
	.round_rate = s5pv2xx_doutapll_roundrate,
};
...
static unsigned long s5pv2xx_clk_doutmpll_get_rate(struct clk *clk)
{
	unsigned long rate = clk_get_rate(clk->parent);
...
struct clk clk_dout_ck166 = {
	...
	.get_rate	= s5pv2xx_clk_doutmpll_get_rate,
};

static unsigned long s5pv2xx_clk_sclk_hdmi_get_rate(struct clk *clk)
{
	unsigned long rate = clk_get_rate(clk->parent);
...
struct clk clk_sclk_hdmi = {
	...
	.get_rate	= s5pv2xx_clk_sclk_hdmi_get_rate,
};
...
static unsigned long s5pv2xx_getrate_clksrc(struct clk *clk)
{
...
static int s5pv2xx_setrate_clksrc(struct clk *clk, unsigned long rate)
{
	struct clksrc_clk *sclk = to_clksrc(clk);
...
static int s5pv2xx_setparent_clksrc(struct clk *clk, struct clk *parent)
{
	struct clksrc_clk *sclk = to_clksrc(clk);
...
static unsigned long s5pv2xx_roundrate_clksrc(struct clk *clk,
					      unsigned long rate)
{
	unsigned long parent_rate = clk_get_rate(clk->parent);
	int div;
...
static struct clksrc_clk clk_mmc0 = {
	.clk	= {
		...
		.enable		= s5pv2xx_clk_ip2_ctrl,
		.set_parent	= s5pv2xx_setparent_clksrc,
		.get_rate	= s5pv2xx_getrate_clksrc,
		.set_rate	= s5pv2xx_setrate_clksrc,
		.round_rate	= s5pv2xx_roundrate_clksrc,
	},
...
static struct clksrc_clk clk_audio1 = {
	.clk	= {
		.name		= "audio-bus",/*SCLK_AUDIO1 in User's Manual*/
		.id		= 1,
...
static struct clksrc_clk clk_audio2 = {
	.clk	= {
		.name		= "audio-bus",/*SCLK_AUDIO2 in User's Manual*/
		.id		= 2,
...
static struct clksrc_clk clk_i2sclk = {
	.clk	= {
		.name		= "audio-bus",/*I2SCLK in User's Manual*/
		.id		= 0,
...
static void __init_or_cpufreq s5pv2xx_set_clksrc(struct clksrc_clk *clk)
{
...
void __init_or_cpufreq s5pv210_setup_clocks(void)
{
	...
	apll = s5pv2xx_get_pll(xtal, __raw_readl(S5P_APLL_CON), S5PV2XX_PLL_APLL);
	mpll = s5pv2xx_get_pll(xtal, __raw_readl(S5P_MPLL_CON), S5PV2XX_PLL_MPLL);
	epll = s5pv2xx_get_pll(xtal, __raw_readl(S5P_EPLL_CON), S5PV2XX_PLL_EPLL);
	vpll = s5pv2xx_get_pll(xtal, __raw_readl(S5P_VPLL_CON), S5PV2XX_PLL_VPLL);
	...
	for (ptr = 0; ptr < ARRAY_SIZE(init_parents); ptr++)
		s5pv2xx_set_clksrc(init_parents[ptr]);
