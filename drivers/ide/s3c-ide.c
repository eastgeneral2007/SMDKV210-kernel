/*
 * s3c-ide.c - Samsung S5PV210 IDE controller Driver
 *
 * Copyright (C) 2009 Samsung Electronics
 *      http://samsungsemi.com/
 *
 * The Samsung IDE controller driver provides low-level support for
 * interfacing with IDE disks. This driver supports PIO and UDMA modes
 * of operation.
 *
...
MODULE_DESCRIPTION("Samsung S5PV210 IDE");
