/* linux/arch/arm/plat-s5pv2xx/include/plat/regs-fimc.h
 *
...
#define S3C_CIILINESKIP_Y			S3C_FIMCREG(0xec)	/* Input DMA Y Line Skip */
#define S3C_CIILINESKIP_CB			S3C_FIMCREG(0xf0)	/* Input DMA Cb Line Skip */
#define S3C_CIILINESKIP_CR			S3C_FIMCREG(0xf4)	/* Input DMA Cr Line Skip */
