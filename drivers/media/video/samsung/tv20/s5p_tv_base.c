...
static int __devinit s5p_tv_probe(struct platform_device *pdev)
{
	...
	/* interrupt */
	TVOUT_IRQ_INIT(irq_num, ret, pdev, 0, out, __s5p_mixer_irq,
		"mixer");
...
#ifdef I2C_BASE
	mutex_for_i2c = kmalloc(sizeof(struct mutex), GFP_KERNEL);
...
static char banner[] __initdata = KERN_INFO "S5PV210 TVOUT Driver, (c) 2009 Samsung Electronics\n";
