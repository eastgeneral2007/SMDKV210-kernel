...
void __init s5pv2xx_init_irq(u32 vic0_valid, u32 vic1_valid, u32 vic2_valid, u32 vic3_valid)
{
	int uart, irq;
	...
	vic_init(S3C_VA_VIC2, S3C_VIC2_BASE, vic2_valid ,0);
	vic_init(S3C_VA_VIC3, S3C_VIC3_BASE, vic3_valid ,0);
