...
#elif defined(CONFIG_ARCH_S5PV2XX)
#define IODESC_ENT(x) { (unsigned long)S5PV2XX_VA_##x, __phys_to_pfn(S5PV2XX_PA_##x), S5PV2XX_SZ_##x, MT_DEVICE }
...
extern void s5pv2xx_init_io(struct map_desc *mach_desc, int size);
...
extern void s5pv2xx_init_irq(u32 vic0, u32 vic1, u32 vic2, u32 vic3);
