...
static int __init s5p_cec_probe(struct platform_device *pdev)
{
	...
	s3c_gpio_cfgpin(S5PV2XX_GPH1(4), S5PV2XX_GPH1_4_HDMI_CEC);
	s3c_gpio_setpull(S5PV2XX_GPH1(4), S3C_GPIO_PULL_NONE);
...
static char banner[] __initdata = "S5PV210 CEC Driver, (c) 2009 Samsung Electronics\n";
