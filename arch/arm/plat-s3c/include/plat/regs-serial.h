...
#if defined(CONFIG_PLAT_S3C64XX) || defined(CONFIG_PLAT_S5PC1XX) || defined(CONFIG_PLAT_S5P64XX) || defined(CONFIG_PLAT_S5PV2XX) 
...
#elif defined(CONFIG_CPU_S5PV210) || defined(CONFIG_CPU_S5P6442)
#define S3C_ULCON         	(0x00)
#define S3C_UCON          	(0x04)
#define S3C_UFCON         	(0x08)
#define S3C_UMCON         	(0x0C)
...
#if !defined(CONFIG_CPU_S3C6400) && !defined(CONFIG_CPU_S3C6410) && !defined(CONFIG_CPU_S5PC100) && !defined(CONFIG_CPU_S5PV210) && !defined(CONFIG_CPU_S5P6442)
