...
extern int s5pv2xx_irq_suspend(struct sys_device *dev, pm_message_t state);
extern int s5pv2xx_irq_resume(struct sys_device *dev);
#else
#define s3c_irqext_wake NULL
#define s3c24xx_irq_suspend NULL
#define s3c24xx_irq_resume  NULL
#define s5pv2xx_irq_suspend	NULL
#define	s5pv2xx_irq_resume	NULL
#endif
